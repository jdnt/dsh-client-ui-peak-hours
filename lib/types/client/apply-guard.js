...
export function claimPeakHoursApply() {
    if (globalThis.__dshPeakHoursApplied === true)
        return false;
 ...
 */
export function releasePeakHoursApply() {
    globalThis.__dshPeakHoursApplied = undefined;
}
//# sourceMappingURL=apply-guard.js.map